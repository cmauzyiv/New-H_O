...
func _process(delta: float) -> void:
	...
	if actor.global_position.x < left_border + left_margin:
		# Prevent the actor for going past the border + the margin
		actor.global_position.x = left_border + left_margin
	...
	elif actor.global_position.x > right_border - right_margin:
		# Prevent the actor for going past the border + the margin
		actor.global_position.x = right_border - right_margin
		# When bouncing we use the .bounce function which takes a wall normal
		# This wall normal is the direction of the face of the wall
