...
class P2Asteroid(pygame.sprite.Sprite): ##this is how the ship will look and spawn
    def __init__(self):
        super(P2Asteroid, self).__init__()
        self.img_asteroid_01 = pygame.image.load('gem2_01.png').convert_alpha()
        self.img_asteroid_02 = pygame.image.load('gem2_02.png').convert_alpha()
        self.img_asteroid_03 = pygame.image.load('gem2_03.png').convert_alpha()
        self.img_asteroid_04 = pygame.image.load('gem2_04.png').convert_alpha()
        self.img_asteroid_05 = pygame.image.load('gem2_05.png').convert_alpha()
        self.img_asteroid_06 = pygame.image.load('gem2_06.png').convert_alpha()
        self.img_asteroid_07 = pygame.image.load('gem2_07.png').convert_alpha()
        self.img_asteroid_08 = pygame.image.load('gem2_08.png').convert_alpha()
        self.img_asteroid_09 = pygame.image.load('gem2_09.png').convert_alpha()
        self.img_asteroid_10 = pygame.image.load('gem2_10.png').convert_alpha()
        ...
        self.scale_value = random.uniform(0.5, 1)
