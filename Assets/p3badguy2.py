...
class ShipBad2(pygame.sprite.Sprite): ##this is how the ship will look and spawn
    def __init__(self):
        ...
        self.img_explosion_01 = pygame.image.load("nd_explosion1.png").convert_alpha()
        self.img_explosion_02 = pygame.image.load("nd_explosion2.png").convert_alpha()
        self.img_explosion_03 = pygame.image.load("nd_explosion3.png").convert_alpha()
        self.img_explosion_04 = pygame.image.load("nd_explosion4.png").convert_alpha()
        self.img_explosion_05 = pygame.image.load("nd_explosion5.png").convert_alpha()
        self.img_explosion_06 = pygame.image.load("nd_explosion6.png").convert_alpha()
        ...
        self.rect.x = random.randrange(c.display_width // 2, c.display_width - self.rect.width)
        self.rect.y = 0
    ...
    def state_attack(self):
        ...
        if self.init_state:
            ...
            self.init_state = False
        if self.rect.x <= c.display_width // 2:
            self.vel_x *= -1
            self.turn_index = 0
        if self.rect.x >= c.display_width - self.rect.width:
            self.vel_x *= -1
            self.turn_index = 0
        if self.vel_x <= 0:
            self.turning_right = False
