...
class Shipbad1(pygame.sprite.Sprite): ##this is how the ship will look and spawn
    def __init__(self):
        ...
        self.img_explosion_01 = pygame.image.load("target_explosion1.png").convert_alpha()
        self.img_explosion_02 = pygame.image.load("target_explosion2.png").convert_alpha()
        self.img_explosion_03 = pygame.image.load("target_explosion3.png").convert_alpha()
        self.img_explosion_04 = pygame.image.load("target_explosion4.png").convert_alpha()
        self.img_explosion_05 = pygame.image.load("target_explosion5.png").convert_alpha()
        self.img_explosion_06 = pygame.image.load("target_explosion6.png").convert_alpha()
        self.img_explosion_07 = pygame.image.load("target_explosion7.png").convert_alpha()
        self.img_explosion_08 = pygame.image.load("target_explosion8.png").convert_alpha()
        self.img_explosion_09 = pygame.image.load("target_explosion9.png").convert_alpha()
        ...
        self.rect.x = random.randrange(2, c.middle_wall - self.rect.width)
        self.rect.y = 0
    ...
    def rev_engine(self):
        ...
        new_engine.rect.x = self.rect.x + 5
        new_engine.rect.y = self.rect.y - 20
    ...
    def state_attack(self):
        ...
        if self.init_state:
            self.vel_y = 0
            while self.vel_x == 0:
                self.vel_x = random.randrange(3, 5)
            self.init_state = False
        if self.rect.x <= c.left_wall:
            self.vel_x *= -1
            self.turn_index = 0
        elif self.rect.x >= (c.middle_wall - self.rect.width):
            self.vel_x *= -1
            self.turn_index = 0
        if self.vel_x <= 0:
            self.turning_right = False
